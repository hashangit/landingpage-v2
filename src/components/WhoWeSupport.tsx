        ...
        <div className="max-w-4xl mx-auto bg-brand-blue/5 rounded-[3rem] p-12 md:p-20 text-center relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <p className="text-xl text-gray-700 leading-relaxed mb-12">
              We work with domiciliary care providers operating at branch, regional, and multi-site level, particularly where workforce mobility is a constraint.
            </p>
            
            <div className="grid sm:grid-cols-3 gap-8">
              <div className="p-6 bg-white rounded-2xl shadow-sm">
                <p className="font-bold text-brand-blue">Single Branch</p>
                <p className="text-sm text-gray-500 mt-2">Local rota stability</p>
              </div>
              <div className="p-6 bg-white rounded-2xl shadow-sm">
                <p className="font-bold text-brand-blue">Regional Groups</p>
                <p className="text-sm text-gray-500 mt-2">Cross-site capacity</p>
              </div>
              <div className="p-6 bg-white rounded-2xl shadow-sm">
                <p className="font-bold text-brand-blue">National Providers</p>
                <p className="text-sm text-gray-500 mt-2">Strategic infrastructure</p>
              </div>
            </div>
          </div>
        </div>
